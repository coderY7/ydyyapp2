		...
		<view class="box-content">
			<u-form labelPosition="left" :model="userInfo" :rules="rules" ref="uForm">
				<u-form-item label="手机号:" prop="phone" borderBottom :labelWidth="60">
					<u-input placeholder="请输入手机号" type="text" border="none" v-model="userInfo.phone">
					</u-input>
				</u-form-item>
				...
				<u-button type="primary" class="my-primary-button" text="绑定手机号" throttleTime="2000" @tap="isphone">
				</u-button>
			</u-form>
