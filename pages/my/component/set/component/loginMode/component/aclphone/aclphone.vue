<template>
	<view class="box" :style="skin">
		...
		<view class="nav-bar">
			...
			<view class="center">换绑手机号</view>
			<view class="right"></view>
		</view>
		<view class="box-content">
			<u-form labelPosition="left" :model="userInfo" :rules="rules" ref="uForm">
				<u-form-item label="原手机号:" prop="phone" borderBottom :labelWidth="80">
					<u-input placeholder="请输入原手机号" type="text" border="none" v-model="userInfo.phone" :disabled="true">
					</u-input>
				</u-form-item>
				<u-form-item label="新手机号:" prop="phone" borderBottom :labelWidth="80">
					<u-input placeholder="请输入新手机号" type="text" border="none" v-model="userInfo.newphone">
					</u-input>
				</u-form-item>
				...
				<u-button type="primary" text="换绑手机号" @click="isphone"></u-button>
			</u-form>
				...
				this.$refs.uForm.validate().then(ress => {
					...
					bindphone(isdata).then(res => {
						...
						if(res.error_code==0){
							...
							uni.setStorageSync('phone', this.userInfo.newphone)
							setTimeout(()=>{
								uni.navigateBack({
									delta: 1
								});
