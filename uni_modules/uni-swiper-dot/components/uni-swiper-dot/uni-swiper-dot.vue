<template>
	<view class="uni-swiper__warp">
		...
		<view v-if="mode === 'nav'" key='nav' :style="{'background-color':dotsStyles.backgroundColor,'bottom':'0'}" class="uni-swiper__dots-box uni-swiper__dots-nav">
			...
			<text :style="{'color':dotsStyles.color}" class="uni-swiper__dots-nav-item" v-if="field">{{ (current+1)+"/"+info.length +' ' +info[current][field] }}</text>
			<text :style="{'color':dotsStyles.color}" class="uni-swiper__dots-nav-item" v-else>{{ (current+1)+"/"+info.length }}</text>
